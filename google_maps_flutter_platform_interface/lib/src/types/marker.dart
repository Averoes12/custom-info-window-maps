...
Object _colorToJson(Color color) {
  return color.toARGB32();
}

/// Native style configuration for a marker info window.
@immutable
class InfoWindowStyle {
  const InfoWindowStyle({
    ...
    this.borderColor,
    this.titleTextColor,
    this.snippetTextColor,
    this.cornerRadius,
    this.borderWidth,
    this.horizontalPadding,
    this.verticalPadding,
    this.titleFontSize,
    this.snippetFontSize,
    this.minWidth,
    this.maxWidth,
    this.titleBold,
    this.snippetBold,
  ...
  final bool? snippetBold;

  InfoWindowStyle copyWith({
    Color? backgroundColorParam,
    Color? borderColorParam,
    Color? titleTextColorParam,
    Color? snippetTextColorParam,
    double? cornerRadiusParam,
    double? borderWidthParam,
    double? horizontalPaddingParam,
    double? verticalPaddingParam,
    double? titleFontSizeParam,
    double? snippetFontSizeParam,
    double? minWidthParam,
    double? maxWidthParam,
    bool? titleBoldParam,
    bool? snippetBoldParam,
  }) {
    return InfoWindowStyle(
      backgroundColor: backgroundColorParam ?? backgroundColor,
      borderColor: borderColorParam ?? borderColor,
      titleTextColor: titleTextColorParam ?? titleTextColor,
      snippetTextColor: snippetTextColorParam ?? snippetTextColor,
      cornerRadius: cornerRadiusParam ?? cornerRadius,
      borderWidth: borderWidthParam ?? borderWidth,
      horizontalPadding: horizontalPaddingParam ?? horizontalPadding,
      verticalPadding: verticalPaddingParam ?? verticalPadding,
      titleFontSize: titleFontSizeParam ?? titleFontSize,
      snippetFontSize: snippetFontSizeParam ?? snippetFontSize,
      minWidth: minWidthParam ?? minWidth,
      maxWidth: maxWidthParam ?? maxWidth,
      titleBold: titleBoldParam ?? titleBold,
      snippetBold: snippetBoldParam ?? snippetBold,
    );
  }
  ...
  Object toJson() {
    ...
    addIfPresent(
      'backgroundColor',
      backgroundColor == null ? null : _colorToJson(backgroundColor!),
    );
    addIfPresent(
      'borderColor',
      borderColor == null ? null : _colorToJson(borderColor!),
    );
    addIfPresent(
      'titleTextColor',
      titleTextColor == null ? null : _colorToJson(titleTextColor!),
    );
    addIfPresent(
      'snippetTextColor',
      snippetTextColor == null ? null : _colorToJson(snippetTextColor!),
    );
    addIfPresent('cornerRadius', cornerRadius);
    addIfPresent('borderWidth', borderWidth);
    addIfPresent('horizontalPadding', horizontalPadding);
    addIfPresent('verticalPadding', verticalPadding);
    addIfPresent('titleFontSize', titleFontSize);
    addIfPresent('snippetFontSize', snippetFontSize);
    addIfPresent('minWidth', minWidth);
    addIfPresent('maxWidth', maxWidth);
    addIfPresent('titleBold', titleBold);
    addIfPresent('snippetBold', snippetBold);
    return json;
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is InfoWindowStyle &&
        other.backgroundColor == backgroundColor &&
        other.borderColor == borderColor &&
        other.titleTextColor == titleTextColor &&
        other.snippetTextColor == snippetTextColor &&
        ...
        other.snippetFontSize == snippetFontSize &&
        other.minWidth == minWidth &&
        other.maxWidth == maxWidth &&
        other.titleBold == titleBold &&
        other.snippetBold == snippetBold;
  }
...
class InfoWindow {
  ...
  /// Native appearance configuration for the info window.
  final InfoWindowStyle? style;
  ...
  Object toJson() {
    ...
    addIfPresent('style', style?.toJson());
  ...
  @override
  int get hashCode => Object.hash(title.hashCode, snippet, anchor, style);

  @override
  String toString() {
    return 'InfoWindow{title: $title, snippet: $snippet, anchor: $anchor, style: $style}';
  }
}
